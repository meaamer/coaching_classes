...
<form class="form-inline" id="search_it">
  <div class="form-group">
    <input type="text" class="form-control" name="std_search" placeholder="Search" id="search" onkeyup="">
  </div>
  ...
  <div id="select"></div>
                      ...
                      <th>Actions</th>
									...
									<tbody id="search_date">
										...
										<tr id="reload<?php echo $item['std_id']; ?>">
											...
											<td><img src="<?php echo base_url($item['std_image']); ?>" class="img-responsive" height="90" width="90"></td>
                      ...
                      ?>
                          ...
                          href="<?=base_url('Student/ActiveStudent/').$item['std_id']?>"><i class="fa fa-pencil" aria-hidden="true" style="font-size:25px"></i>
</a>
											</td>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="myModal">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
    	<div class="modal-header bg-danger" style="background:#ffffff; color: #b5b0b0;">
            ...
            <form id="frmsend" enctype="multipart/form-data" method="POST" role="from">
                  <div class="row">
                      <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control input-sm" id="" placeholder="Full Name" name="full_name" value="<?php if(isset($rows)){echo $rows['std_full_name']; } ?>" required="">
                      </div>
                      <div class="form-group col-md-6">
                        <label >Mother Name</label>
                        <input type="text" class="form-control input-sm" id="" placeholder="Mother Name" name="mother_name" value="<?php if(isset($rows)){echo $rows['std_mother_name']; } ?>" required>
                      </div>
                  </div>
                  <div class="row"> 
                  ...
                  <label class="radio-inline"><input type="radio" name="gender" value="famale" <?php if(isset($rows)){echo ($rows['std_gender']=='female')? 'checked="checked"':'';}?> required>Female</label>
                    </div>
                    </div>
                  <div class="form-group col-md-6">
                    <label >Password</label>
                    <input type="password" class="form-control input-sm" placeholder="Password" name="password"
                    value="<?php if(isset($rows)){echo $rows['std_password']; } ?>" required>
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <select class="form-control input-sm" name="course" required>
                      ...
                      <option value="<?php echo $course_list['course_name'];?>" <?php if(isset($rows)){ if($rows['std_course']==$course_list['course_name']){echo "selected";}}?>>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <?php if(!empty($course)){ foreach ($course as $course_list){ ?>                <option value="<?php echo $course_list['course_fees'];?>"
                    <?php if(isset($rows)){
...
<div class="modal-footer bg-danger" style="background:rgba(218, 212, 212, 0.15);">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        <?php if (isset($rows)) { ?><button type="button" class="btn btn-danger" onclick="UpdateStudent(<?=$rows['std_id']?>);">Update</button> 
          <?php } else { ?>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="student_details">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="gridSystemModalLabel">Student Addmission Details</h4>
      </div><br>
     <div id="print"></div>
